...
class Toast {
  ...
  _create() {
    ...
    let html = `{header}<a class= "a_toast" href='` + this._texturl +`'><div class="toast__body"></div></a><button class="toast__close" type="button"></button>`;
   //let html = `{header}<a href='#'></a><button class="toast__close" type="button"></button>`;
    const htmlHeader = this._title === false ? '' : '<a class= "a_toast" href=' + this._texturl +'><div class="toast__header"></div></a>';
